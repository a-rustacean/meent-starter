...
/** @type {HTMLDivElement} */
const verifyEmailToast = document.getElementById("verify-email-toast");
let isLoading = false;
...
verifyEmailButton.addEventListener("click", () => {
  ...
  isLoading = true;
  post("/verify-email", undefined, (err) => {
    if (err) {
    ...
    verifyEmailToast.parentElement.removeChild(verifyEmailToast);
  });
});
